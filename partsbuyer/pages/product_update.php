...
// First of all we need to check if this file is loaded very first time or not.
// We need to check the imput if the file is loaded again after
// input of edited values of product attributes..
...
//selecting attributes data associated with this particular product id
...
<br>
  ...
  <div class="panel-body">
    ...
    <!-- this area will display the form for user input to edit value of the attributes -->
    <form action="product_update.php" method="post">
        <div class="form group">
            ...
            <input type="number" class="form-control" id="prod_cost" name="prod_cost" value="<?php echo $prod_cost;?>">
            <label for="prod_price">Product Price (£):</label>
            <input type="number" class="form-control" id="prod_price" name="prod_price" value="<?php echo $prod_price;?>">
