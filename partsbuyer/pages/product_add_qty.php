...
// to add product quantity, first we need to make sure if this file is called by submitting the quantity i.e. this file is not loading very first time.
if(isset($_POST['submit']))
{
    $prod_id = mysqli_real_escape_string($dbconn, $_POST['prod_id']);

    $prod_name=isset($_POST['prod_name']);
    $prod_desc=isset($_POST['prod_desc']);
    $prod_qty=isset($_POST['prod_qty']);
    $prod_cost=isset($_POST['prod_cost']);
    $prod_price=isset($_POST['prod_price']);
    $category=isset($_POST['category']);
    $supplier=isset($_POST['supplier']);
    $prod_serial=isset($_POST['prod_serial']);
...
<?php
    ...
    //selecting product data fields associated with this particular id
  ...
  <div class="panel-body">
    <form action="product_add_qty.php" method="post">
        <div class="form group">
            ...
            <label for="prod_price">Product Cost (£): &nbsp &nbsp &nbsp &nbsp <?php echo $prod_price;?></label><br><br>
